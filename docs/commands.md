...
เมื่อพบ จึงใช้กับ cron/monitoring ได้ และเป็นคู่คำสั่งเดียว (นอกจาก
version/help/logs) ที่ไม่ถือ WOR_HOME lock -- เครื่องมือวินิจฉัย
ต้องไม่ถูกบล็อกตอนเกิดเหตุ
